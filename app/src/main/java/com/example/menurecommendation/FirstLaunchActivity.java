        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBoxPork.isChecked() && checkBoxChicken.isChecked() && checkBoxBeef.isChecked() && NOMSpinner.getSelectedItemPosition()!=0){
                    //Toast.makeText(FirstLaunchActivity.this, "cant", Toast.LENGTH_LONG).show();
                    Toast toast = Toast.makeText(FirstLaunchActivity.this, "If all Meat are selected simultaneously, the Meat spinning must be 0", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                    isDisable = true;
                }
                if (checkBoxLettuce.isChecked() && checkBoxBroccoli.isChecked() && checkBoxSpinach.isChecked() && NOVSpinner.getSelectedItemPosition()!=0){
                    //Toast.makeText(FirstLaunchActivity.this, "cant", Toast.LENGTH_LONG).show();
                    Toast toast = Toast.makeText(FirstLaunchActivity.this, "If all Veggie are selected simultaneously, the Meat spinning must be 0", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                    isDisable = true;
                }
                if (checkBoxWS.isChecked() && checkBoxCS.isChecked() && NOSSpinner.getSelectedItemPosition()!=0){
                    //Toast.makeText(FirstLaunchActivity.this, "cant", Toast.LENGTH_LONG).show();
                    Toast toast = Toast.makeText(FirstLaunchActivity.this, "If all Soup are selected simultaneously, the Meat spinning must be 0", Toast.LENGTH_LONG);
                    toast.setGravity(Gravity.CENTER, 0, 0);
                    toast.show();
                    isDisable = true;
                }
...
//                    setResult(RESULT_OK, welcomeIntent);
//                }
                //if(NOMSpinner.getSelectedItem().toString()!=0) {


                //Toast.makeText(v.getContext(), "cant", Toast.LENGTH_LONG).show();
